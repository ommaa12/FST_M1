...
//        driver.findElement(AppiumBy.id("add_task_title")).click();
        ...
        // Assertion
        wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.id("tasks_list")));

        // Find all the tasks on the list
        List<WebElement> tasksList = driver.findElements(AppiumBy.id("task_data"));
